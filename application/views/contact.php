			...
			<section class="contact-page-area section-gap">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-8">
							<form class="form-area action="<?php echo base_url('Welcome/sendmail') ?>" method="post">
								<div class="row">
									...
									<div class="col-lg-6 form-group">
										...
										<button type="submit" value="submit" name="submit"class="primary-btn mt-20 text-white" style="float: right;">Send Message</button>
									</div>
								</div>
							</form>
						</div>
